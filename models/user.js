...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    static associate(models) {
      ...
      this.hasMany(models.Chat, { as: "creator_chat", foreignKey: "creator_id" });
      this.hasMany(models.Chat, { as: "receiver_chat", foreignKey: "receiver_id" });
      ...
      this.belongsToMany(models.User, { foreignKey: "user1_id", through: models.Friend, as: "user2"})
      this.belongsToMany(models.User, { foreignKey: "user2_id", through: models.Friend, as: "user1"})
      this.belongsToMany(models.User, { foreignKey: "creator_id", through: models.Chat, as: "receiver_chat_user"})
      this.belongsToMany(models.User, { foreignKey: "receiver_id", through: models.Chat, as: "creator_chat_user"})
    }
  }
  User.init(
    {
